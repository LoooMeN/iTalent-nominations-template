...
<head>
    ...
    <title>АПАРАТНА РОЗРОБКА | iTalent всеукраїнський конкурс з IT та кіберспорту</title>
</head><body>
    <script>
        var page = 'PROGAPP';
    </script>
    <section class='section' id='aboutNomination'>
    <h1 class='title'>АПАРАТНА РОЗРОБКА</h1>
    <p>У цій номінації вам потрібно зробити програмуємий пристрій (робот, вимірювач, ферму і т.д.). Уважно читайте вимоги до вашої розробки.</p>
</section>
        ...
        <div class='ageGroupsWrapper'>
            <div class='ageGroupWrapper shadow'>
                <div class='ageGroupPreview'>
                    <img src='/includes/images/backgrounds/ProgApAgeBg_1.jpeg'
