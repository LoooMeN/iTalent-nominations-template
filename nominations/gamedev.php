...
<head>
    ...
    <title>GAMEDEV | iTalent всеукраїнський конкурс з IT та кіберспорту</title>
</head><body>
    ...
    <section id='ageGroups' class='section'>
        <div class='ageGroupsWrapper'>
            <div class='ageGroupWrapper shadow'>
                <div class='ageGroupPreview'>
                    <img loading='lazy'  src='/includes/images/backgrounds/GameAgeBg_1.webp'
        ...
        <div class='ageGroupPreview'>
            <img loading='lazy'  src='/includes/images/backgrounds/GameAgeBg_2.webp'
                alt='Вікова категорія 1'>
    ...
    <div class='vimogaWrapper'>
                    ...
                    <img loading='lazy'  class='icon' src='/includes/images/icons/monitor.svg' alt='icon'>
                    <div class='text'>
                        <h3>Якщо в грі</h3>
