...
<head>
    ...
    <title>ПРОГРАМНА ОБРОБКА ТЕКСТІВ | iTalent всеукраїнський конкурс з IT та кіберспорту</title>
</head><body>
    ...
    <h1 class='title'>ПРОГРАМНА ОБРОБКА ТЕКСТІВ</h1>
    ...
    <section class='section' id='partner'>
        ...
        <div>
            <a href='https://www.grammarly.com/' target='_blank' rel='noopener noreferrer'><img loading='lazy' 
                    src='/includes/images/partners/logo-grammarly.svg' alt='Grammarly'></a>
            <p><span>Grammarly</span> — це міжнародна компанія, яку заснували українці. Нещодавно вона стала 'єдинорогом' (її вартість перевищила 1 млрд $). Grammarly створює онлайн-сервіс на основі штучного інтелекту для допомоги в написанні текстів англійською мовою.</p>
        </div>
    </section>
        ...
        <div class='ageGroupsWrapper'>
            <div class='ageGroupWrapper shadow'>
                <div class='ageGroupPreview'>
                    <img loading='lazy'  src='/includes/images/backgrounds/ProgTextAgeBg.webp'
                        alt='Вікова категорія 1'>
                    <div class='age blueGrad'>
                        <h2>Від 8 до 19 років</h2>
                        <p>Тема роботи: на вибір</p>
                    </div>
                </div><ul class='explanation'><ul class='explanation shown'><p>Проблеми, які ваш проект може вирішувати:</p><li>Електронний конспект. Додаток, який дозволяє сфотографувати свій конспект і розпізнати його.Може бути корисно, щоб робити пошук по конспектах з таких предметів, як історія чи зарубіжна література.</li><li>Питально-відповідальна система з якогось предмету (наприклад, з географії) за структурованою інформацією з підручника.</li><li>Визначення фейкових новин / визначення тролінгу в коментарях до новин.</li><li>Перекладач з діалектної української на літературну (і навпаки). Можна брати будь-який діалект України: львівську ґвару, подільський діалект, волинський діалект, лемківську мову, закарпатський говір тощо.</li><li>Транслітератор власних назв з англійської на українську (Hemingway =&gt; Гемінґвей).</li><li>Зібрати імена добрих і злих літературних персонажів і написати класифікатор на лінгвістичних ознаках, який визначає, чи персонаж із вашим іменем був би злим чи добрим.</li><li>Генератор мовних каламбурів.</li><li>Визначення вірусних заголовків новин: як написати заголовок новини так, щоб на нього клацала максимальна кількість людей.</li><li>Своя (вільна) тема, яка стосується опрацювання текстів.</li></ul></ul></div>        </div>
