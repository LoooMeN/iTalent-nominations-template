...
<body>
    ...
    <p>У цій номінації вам потрібно зробити мобільний або десктопний додаток. Уважно читайте вимоги до вашої розробки.</p>
</section>
    ...
    <section id='ageGroups' class='section'>
        <div class='ageGroupsWrapper'>
            <div class='ageGroupWrapper shadow'>
                ...
                </div><ul class='explanation'>Проблеми які ваш проект може вирішувати: Пошук телефонів (де друга шкарпетка?)Оффлайн путівник по пам’яткам міст (міні гід у телефоні)Вимк / Вкл фун-ції телефона за геолокацією (безшумний режим у школі)SOS додатки (наприклад: сповіщення поліції про пограбування)Додатки для дієти (по штрихкоду дізнатись кількість калорій)</ul></div><div class='ageGroupWrapper shadow'>
        <div class='ageGroupPreview'>
