...
<head>
    ...
    <title>ВІДЕО МЕЙКІНГ | iTalent всеукраїнський конкурс з IT та кіберспорту</title>
</head><body>
    <script>
        var page = 'VID';
    </script>
    ...
    <p>У цій номінації вам потрібно написати сценарій, зняти і змонтувати свій трейлер до фільму / мультфільму. Головна задача - зацікавити трейлером глядача до перегляду фільму / мультфільму. Уважно читайте завдання до відеоролику.</p>
</section>
